...
query = (
    "could you summarize the doc please"
)

newQuery = "Could you provide a summary of the recipes contained within the document?"
...
def retrieve_context(newQuery: str):
    """Retrieve information to help answer a query."""

    # get only the top 3 answers
    retrieved_docs_with_score = vectordb.similarity_search_with_score(newQuery, k=10)

    # BM25 : score lexical
    query_tokens = newQuery.split()
